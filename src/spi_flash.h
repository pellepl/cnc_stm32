...
enum spi_flash_state_e {
  ...
  SPI_FLASH_STATE_CLOSED ,
  SPI_FLASH_STATE_OPENED,

  SPI_FLASH_STATE_CLOSING,
  SPI_FLASH_STATE_OPENING_READ_ID,

  SPI_FLASH_STATE_READ_BUSY,

  SPI_FLASH_STATE_READ,

  SPI_FLASH_STATE_WRITE_SEQ,
  SPI_FLASH_STATE_WRITE_WAIT,

  SPI_FLASH_STATE_ERASE_SEQ,
  SPI_FLASH_STATE_ERASE_WAIT,

  SPI_FLASH_STATE_WRSR_SEQ,
  SPI_FLASH_STATE_WRSR_WAIT,

  SPI_FLASH_STATE_MASS_ERASE
